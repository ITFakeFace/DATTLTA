...
{
	internal static class BSTreePrinter //where T : IComparable<T>
	{
		class NodeInfo
		{
			public BSNode<int>? Node;
			public string? Text;
			public int StartPos;
		...
		public static void Print(this BSNode<int> root, int topMargin = 2, int leftMargin = 2)
		{
			if (root == null) return;
